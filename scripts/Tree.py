...
parser.add_argument('-a', '--algorithm', action='store', dest="algorithm", default="DT", required=False, help="Input Pcap File.")
parser.add_argument('-d', '--dataset', action='store', dest="dataset", default="../datasets/UNI1.csv", required=False, help="Test dataset.")
parser.add_argument('-w', '--weigth', action='store', dest="wt", default=10, required=False, help="Window Time Off Flow.")
