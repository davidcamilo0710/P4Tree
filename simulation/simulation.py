...
parser.add_argument('-i', '--input', action='store', dest="pcap_in", default="../PCAPs/fast_test.pcap", required=False, help="Input Pcap File.")
parser.add_argument('-t', '--tree', action='store', dest="tree", default="../scripts/tree_DT.sav", required=False, help="Input Tree .sav file.")
parser.add_argument('-w', '--window', action='store', dest="window_size", default=5, required=False, help="Window Time Off Flow.")
parser.add_argument('-c', '--count', action='store', dest="max_count", default=0x1f1f1f1f, type=int, required=False, help="Read Packet Count.")
...
for packet, (sec, usec, wirelen, caplen) in RawPcapReader(pcap_input):
    try:
        ...
        if ether_packet[IP]:
            ...
            ip_packet = ether_packet[IP]       # <<<< Assuming Ethernet + IPv4 herez
            ...
            if five_tuple_key not in pcap_statistics["flow_set_5_tuple"]:
                ...
                pcap_statistics['dataPredict'][five_tuple_key] = [6, 9404, 1987, 60, 162, 134, 138, 230, 1434, 491]
            ...
            if pcap_statistics['5_tuple_pkt_cnt_table'][five_tuple_key] == 7:
                ...
                flow_test = [protocol, sport, dport, pcap_statistics['packt1'][five_tuple_key], pcap_statistics['packt2'][five_tuple_key], pcap_statistics['packt3'][five_tuple_key], pcap_statistics['packt4'][five_tuple_key], pcap_statistics['packt5'][five_tuple_key], pcap_statistics['packt6'][five_tuple_key], pcap_statistics['packt7'][five_tuple_key]]
...
FPR = 100*pcap_statistics['count_mices_BP']/(pcap_statistics["flow_num_5_tuple"] - pcap_statistics['count_elephants'])
