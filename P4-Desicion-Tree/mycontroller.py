...
class ReadCounters(object):
    ...
    def read(self):
        ...
        elephants_BP = self.controller.counter_read('counter_false_detection_Elephant', 0)
        mice_BD_sum = self.controller.counter_read('counter_false_detection_mice', 0)
        mice_BD_rest = self.controller.counter_read('counter_false_detection_mice_rest', 0)
