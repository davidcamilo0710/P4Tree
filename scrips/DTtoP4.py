...
from sklearn.tree import _compute_depth
...
def export_p4(decision_tree):
    ...
    def _add_leaf(value, class_name, indent, prevfeature, result, depth, previous_id):
        ...
        print("table_add MyIngress.level", depth, " ", "MyIngress.SetClass"," ", previous_id," ",prevfeature," ", result," ", "=>"," ", current_id, " ", int(float(class_name)), sep="")
        ...
        if depth <= max_depth+1:
            ...
            if tree_.feature[node] != _tree.TREE_UNDEFINED:
                ...
                if int(name) == 9 or int(name) == 11:
                   ...
                   print("table_add MyIngress.level", depth, " MyIngress.CheckFeature ", previous_id, " ", prevfeature, " ", result, " ", "=>", " ", current_id, " ", name," ", hex(int(float(threshold))), sep='')
...
print("Tree in commands.txt")
sys.stdout = open("commands.txt", "w")    
export_p4(rf)
sys.stdout.close()