        ...
        if depth <= max_depth+1:
            ...
            if tree_.feature[node] != _tree.TREE_UNDEFINED:
                ...
                if int(name) == 9 or int(name) == 11:
                    ...
                    print("table_add MyIngress.level_", i_tree, "_", depth, " MyIngress.CheckFeature ", previous_id, " ",
                          prevfeature, " ", result, " ", "=>", " ", current_id, " ", name, " ", hex(int(float(threshold))), sep='')
...
print("Tree in commands_RF.txt")
sys.stdout = open("commands_RF.txt", "w")
